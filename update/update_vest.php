...
<body>
    <div class="container">
        ...
        <form action="../modelo.php" class="formulario" method="post">
            ...
            <input type="hidden" name="vestuario_id" id="vestuario_id" value="<?php echo $row['vestuario_id']; ?>"
                required>
            ...
            <th> <label id="b" for="vestuario_des">Descrição:</label>
                <input type="text" name="vestuario_des" id="vestuario_des" value="<?php echo $row['vestuario_desc']; ?>"
                    required>
            </th>
            </br>
